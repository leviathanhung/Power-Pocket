...
<html>
    <head>
        <title>Receipt/payment Home</title>
            ...
            <div class="card-deck">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Effortlessly manage your Bill and stay organized.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Customizable Categories</h5>
                        <p class="card-text">Create and customize categories to organize your Bill the way you want.</p>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Receive timely reminders to help you stay on top of your Receipt/payment.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="text-center">
                        ...
                        <p>Thank you for visiting Receipt/payment!</p>
                    </div>
                </div>
            </div>
        </div>
